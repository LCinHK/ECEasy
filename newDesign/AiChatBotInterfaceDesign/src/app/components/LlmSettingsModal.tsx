...
export function LlmSettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/35 px-4 py-4 sm:items-center sm:py-6">
      <div className="flex w-full max-w-lg max-h-[calc(100vh-2rem)] flex-col overflow-hidden rounded-2xl border border-amber-200 bg-white shadow-2xl sm:max-h-[calc(100vh-3rem)]">
          ...
          <div className="mt-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={DEFAULT_BASE_URL_BY_PROVIDER[selectedProvider] || 'https://api.example.com'}
        ...
        <div className="shrink-0 border-t border-amber-100 bg-white px-5 py-4 sm:px-6">
